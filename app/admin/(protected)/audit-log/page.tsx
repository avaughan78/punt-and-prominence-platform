...
const EVENT_META: Record<string, {
  ...
  'invite.updated':        { category: 'invite',   icon: '✏️', label: 'Collab updated',  summary: (m: Record<string, unknown>) => `"${m.title ?? 'Collab'}" was updated${Array.isArray(m.changes) ? ': ' + (m.changes as string[]).join(' · ') : ''}` },
